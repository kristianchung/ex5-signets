...
import TrierDossier from './TriDossiers';
...
export default function Appli() {
  ...
  const triSelectionner = useState(['datemodif','desc']);
        ...
        utilisateur ?
          <>
            ...
            <section className="contenu-principal">
              <TrierDossier triSelection={triSelectionner} />
              <ListeDossiers utilisateur={utilisateur} etatDossiers={etatDossiers} triSelection={triSelectionner} />
